...
#ifndef _CUTS_MODELIO_MODELGEN_H_
#define _CUTS_MODELIO_MODELGEN_H_
...
namespace utils
{
  ...
  public:
     ...
     */
    template <typename P, typename T>
    bool operator () (const P & parent, 
                      const std::string & metatype, 
                      T & element);

    template <typename T>
    bool operator () (const GME::Collection_T <T> & current, 
                      T & element);
  ...
  private:
    ...
    bool find_i (ITER iter_begin, ITER iter_end, 
  ...
  template <typename P, typename T, typename PRED>
  bool find (P & parent, const std::string & metatype,
...
#endif  // !defined _CUTS_MODELIO_MODELGEN_H_
