...
Visit_ImplementationArtifactReference (const PICML::ImplementationArtifactReference & ref)
{
  ...
  PICML::ComponentImplementationArtifact cia = PICML::ComponentImplementationArtifact::Cast (ref);
  cia.Accept (*this);
}
...
//
void Servant_Header_Generator::
Visit_ComponentImplementationArtifact (const PICML::ComponentImplementationArtifact & artifact)
{
