...
void CUTS_BE_Project_File_Open_T <CUTS_BE_TCPIP_Ctx, CUTS_BE_Impl_Node>::
...
void CUTS_BE_Project_File_Begin_T <CUTS_BE_TCPIP_Ctx, CUTS_BE_Impl_Node>::
...
generate_exec_project (const CUTS_BE_Impl_Node & node)
{
  ...
  this->ctx_.project_
    << "project (" << project_name << ") : ciao_executor, cuts_tcpip, cuts_codegen_defaults {" << std::endl
...
generate_svnt_project (const CUTS_BE_Impl_Node & node)
{
  ...
  this->ctx_.project_
    << "project (" << svnt_project << ") : cuts_tcpip_ccm, cuts_codegen_defaults {" << std::endl
...
void CUTS_BE_Project_File_Open_T <CUTS_BE_TCPIP_Ctx, CUTS_BE_IDL_Node>::
...
void CUTS_BE_Project_File_Begin_T <CUTS_BE_TCPIP_Ctx, CUTS_BE_IDL_Node>::
generate (const CUTS_BE_IDL_Node &)
{
  this->ctx_.project_
    << CUTS_BE_CPP::single_line_comment ("-*- MPC -*-")
    << std::endl;
}
...
generate_idlgen_project (const CUTS_BE_IDL_Node & node)
{
  ...
  this->ctx_.project_
    << "project (" << node.name_ << "_IDL_Gen) : ciaoidldefaults {" << std::endl
    << "  custom_only = 1" << std::endl
    << std::endl
...
// CUTS_BE_Project_File_End_T
//
bool CUTS_BE_Project_File_End_T <CUTS_BE_TCPIP_Ctx, CUTS_BE_IDL_Node>::
generate (const CUTS_BE_IDL_Node & node)
{
  this->ctx_.project_
...
CUTS_BE_TCPIP_Ctx, CUTS_BE_IDL_Node>::generate (void)
{
  if (this->ctx_.project_.is_open ())
    this->ctx_.project_.close ();
}
