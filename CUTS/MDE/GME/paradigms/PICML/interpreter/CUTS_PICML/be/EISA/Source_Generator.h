...
#ifndef _CUTS_EISA_SOURCE_GENERATOR_H_
#define _CUTS_EISA_SOURCE_GENERATOR_H_

#include "Generator_Base.h"
#include "Port_Manager_T.h"

/**
 * @class CUTS_EISA_Source_Generator
 */
class CUTS_EISA_Source_Generator :
  public CUTS_EISA_Generator_Base
{
public:
  typedef CUTS_EISA_Generator_Base _super;

  CUTS_EISA_Source_Generator (void);

  virtual ~CUTS_EISA_Source_Generator (void);
...
#endif  // !defined _CUTS_EISA_SOURCE_GENERATOR_H_
