...
//=============================================================================
/**
 * @file      CUTS_EISA_Generator_Base.h
 *
 * $Id$
 *
 * @author    James H. Hill
...
/**
 * @class CUTS_EISA_Generator_Base
 */
class CUTS_EISA_Generator_Base : public CUTS_BE_File_Traits
{
public:
  typedef CUTS_BE_File_Traits _super;

  CUTS_EISA_Generator_Base (void);

  virtual ~CUTS_EISA_Generator_Base (void);
