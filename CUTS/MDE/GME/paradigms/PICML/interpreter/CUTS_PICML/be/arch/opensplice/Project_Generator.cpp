...
void CUTS_BE_Project_File_Open_T <CUTS_BE_OpenSplice::Context, CUTS_BE_Impl_Node>::
...
void CUTS_BE_Project_File_Begin_T <CUTS_BE_OpenSplice::Context, CUTS_BE_Impl_Node>::
...
//
// CUTS_BE_Project_Write_T <CUTS_BE_OpenSplice::Context, CUTS_BE_Impl_Node>
//
void
CUTS_BE_Project_Write_T <CUTS_BE_OpenSplice::Context, CUTS_BE_Impl_Node>::
generate (const CUTS_BE_Impl_Node & node)
...
//
void CUTS_BE_Project_Write_T <CUTS_BE_OpenSplice::Context, CUTS_BE_Impl_Node>::
...
//
void
CUTS_BE_Project_File_End_T <CUTS_BE_OpenSplice::Context, CUTS_BE_Impl_Node>::
generate (const CUTS_BE_Impl_Node & node)
{
  this->ctx_.project_
...
//
void
CUTS_BE_Project_File_Close_T <CUTS_BE_OpenSplice::Context, CUTS_BE_Impl_Node>::
generate (void)
{
...
void CUTS_BE_Project_File_Open_T <CUTS_BE_OpenSplice::Context, CUTS_BE_IDL_Node>::
...
void CUTS_BE_Project_File_Begin_T <CUTS_BE_OpenSplice::Context, CUTS_BE_IDL_Node>::
...
// CUTS_BE_Project_File_End_T
//
bool CUTS_BE_Project_File_End_T <CUTS_BE_OpenSplice::Context, CUTS_BE_IDL_Node>::
generate (const CUTS_BE_IDL_Node & node)
{
  this->ctx_.project_
...
CUTS_BE_OpenSplice::Context, CUTS_BE_IDL_Node>::generate (void)
{
  if (this->ctx_.project_.is_open ())
    this->ctx_.project_.close ();
}
