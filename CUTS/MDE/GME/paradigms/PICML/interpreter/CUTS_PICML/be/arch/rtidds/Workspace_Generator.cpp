...
//
void
CUTS_BE_Workspace_File_Open_T <CUTS_BE_RTIDDS::Context>::
...
//
void CUTS_BE_Workspace_Begin_T <CUTS_BE_RTIDDS::Context>::
generate (const std::string & name)
{
...
//
void
CUTS_BE_Workspace_Project_Include_T <CUTS_BE_RTIDDS::Context, CUTS_BE_Impl_Node>::
...
//
void
CUTS_BE_Workspace_Project_Include_T <CUTS_BE_RTIDDS::Context, CUTS_BE_IDL_Node>::
...
//
void CUTS_BE_Workspace_End_T <CUTS_BE_RTIDDS::Context>::
generate (const std::string & name)
{
  this->ctx_.workspace_
    << "}" << std::endl
...
//
void CUTS_BE_Workspace_File_Close_T <CUTS_BE_RTIDDS::Context>::generate (void)
{
