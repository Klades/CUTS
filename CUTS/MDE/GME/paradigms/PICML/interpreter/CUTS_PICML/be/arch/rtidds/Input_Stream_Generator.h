...
#ifndef _CUTS_RTIDDS_BE_INPUT_STREAM_GENERATOR_H_
#define _CUTS_RTIDDS_BE_INPUT_STREAM_GENERATOR_H_
...
#endif  // !defined _CUTS_RTIDDS_BE_INPUT_STREAM_GENERATOR_H_
