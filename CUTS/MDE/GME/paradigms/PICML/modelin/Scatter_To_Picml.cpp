...
struct find_instance
{
  find_instance (GME::Project & project,
...
private:
  ...
  const Picmlin_Options & options_;
  ...
  public boost::spirit::grammar <CUTS_Scatter_To_Picml_Parser>
{
  ...
  /// The current options for the parser.
  const Picmlin_Options & options_;
};
                                 ...
                                 const Picmlin_Options & options)
{
  ...
  GME::Folder target_deployment_folder;

  get_target_deployment_folder (project, 
                                target_deployment_folder, 
                                options.target_deployment_folder_);

  // Parse the select file.
  CUTS_Scatter_To_Picml_Parser parser (project, 
                                       target_deployment_folder, 
                                       options);
