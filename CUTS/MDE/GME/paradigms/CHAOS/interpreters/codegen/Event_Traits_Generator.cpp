...
void Event_Traits_Generator::Visit_Event (const CHAOS::Event & event)
{
  ...
  this->out_
    ...
    << " */" << std::endl
    << "template < >" << std::endl
    << "class " << this->export_ << " CUTS_OpenSplice_Traits_T < ::CUTS_DDS::" << fq_type << " >"
    << "{"
    << "public:" << std::endl
    ...
    << "typedef ::CUTS_DDS::" << fq_type << "Seq_var dds_event_sequence_var_type;"
    << std::endl
    << "typedef ::CUTS_DDS::" << fq_type << "TypeSupportInterface dds_typesupport_interface_type;"
    ...
    << "typedef ::CUTS_DDS::" << fq_type << "TypeSupport_var dds_typesupport_var_type;"
    << std::endl
