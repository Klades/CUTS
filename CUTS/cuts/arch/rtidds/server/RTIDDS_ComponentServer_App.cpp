...
// run_main
//
int CUTS_RTIDDS_CCM_ComponentServer_App::run_main (int argc, char * argv[])
{
...
// parse_args
//
int CUTS_RTIDDS_CCM_ComponentServer_App::parse_args (int argc, char * argv [])
{
...
// print_help
//
void CUTS_RTIDDS_CCM_ComponentServer_App::print_help (void)
{
  ACE_OS::exit (1);
}
