...
@rem set CLASSPATH=%CLASSPATH%;%CONTRIB_ROOT%\spring.jar
@rem set CLASSPATH=%CLASSPATH%;%CONTRIB_ROOT%\log4j-1.2.15.jar
@rem set CLASSPATH=%CLASSPATH%;%CONTRIB_ROOT%\commons-logging-1.1.1.jar
