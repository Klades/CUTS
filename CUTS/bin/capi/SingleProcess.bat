...
@set CUTS_CLASSPATH=%CUTS_ROOT%\lib\cuts.java.capi.deployment.jar;%CUTS_ROOT%\lib\cuts.java.jar;%CUTS_ROOT%\lib\cuts.java.capi.jar;%CUTS_ROOT%\contrib\java\spring.jar;%CUTS_ROOT%\contrib\java\log4j-1.2.15.jar;%CUTS_ROOT%\contrib\java\commons-logging-1.1.1.jar;%CUTS_ROOT%\contrib\java\castor-1.2.jar
