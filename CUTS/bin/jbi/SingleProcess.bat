...
java -classpath %CUTS_CLASSPATH%;%JBI_CLASSPATH%;%CLASSPATH% -Dorg.omg.CORBA.ORBClass=org.jacorb.orb.ORB -Dorg.omg.CORBA.ORBSingletonClass=org.jacorb.orb.ORBSingleton %JAVA_OPTS% cuts.java.jbi.deployment.JbiClientApp %*
