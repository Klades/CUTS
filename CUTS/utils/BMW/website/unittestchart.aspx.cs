...
namespace CUTS
{
  public partial class Unit_Test_Chart : System.Web.UI.Page
  {
    ...
    protected void Page_Load (object sender, EventArgs e)
    {
      ...
      DataTable table = UnitTestActions.evaluate_unit_test (test_num, id, false, ref evaluation);

      Chart (evaluation, table);
...
public class ChartingAPI
{
  ...
  public void set_grid_horizontal (int thickness, string hex_color, int alpha, line_types type)
  {
    ...
    writer.WriteAttributeString("thickness",(string)thickness);
    writer.WriteAttributeString("color",hex_color);
    writer.WriteAttributeString("alpha",(string)alpha);
