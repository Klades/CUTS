...
above \footnote{It is recommended you download either the latest snapshot 
or beta version of DOC middleware tarball.}, please define the following 
...
(*@\texttt{\%> cd \$ADBC\_ROOT}@*)
(*@\texttt{\%> \$ACE\_ROOT/bin/mwc.pl -type [build tool] [-features <features>] ADBC.mwc}@*)
(*@\texttt{\%> gmake}@*)\end{lstlisting}
