...
#include "RTIDDS_SimpleComponent_svnt.h"
...
namespace RTIDDS_SimpleComponent_Basic_Impl
{
  ...
  // writer_emitEvent
  //
  CUTS_RTIDDS_CCM_Subscriber & SimpleComponent_Servant_Context::
...
create_SimpleComponent_Servant (const char * name, ::Components::EnterpriseComponent_ptr p)
{
  return ::CUTS::CCM::create_servant <
    ...
    ::RTIDDS_SimpleComponent_Basic_Impl::SimpleComponent_Servant > (name, p);
}
