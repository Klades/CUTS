...
namespace CIDL_CPUBoundImpl
{
  ...
  void CPUBound::push_InPortB_i (antispam::NullEvent * ev)
  {
    ...
    if (this->logEventB_)
    {
      this->logger_.log (LM_INFO, "%s is preprocessing event %d at %d", this->instName_.c_str (), this->eventCountB_, ACE_OS::gettimeofday ().msec ());
    }

    this->mycpu_.profile_run ("preB");
    if (this->logEventB_)
    {
      this->logger_.log (LM_INFO, "%s is postprocessing event %d at %d", this->instName_.c_str (), this->eventCountB_, ACE_OS::gettimeofday ().msec ());
    }
    ...
    if (this->logEventB_)
    {
      this->logger_.log (LM_INFO, "%s is finalizing event %d at %d", this->instName_.c_str (), this->eventCountB_, ACE_OS::gettimeofday ().msec ());
    }
  ...
  void CPUBound::push_InPortA_i (antispam::NullEvent * ev)
  {
    ...
    if (this->logEventA_)
    {
      this->logger_.log (LM_INFO, "%s is preprocessing event %d at %d", this->instName_.c_str (), this->eventCountA_, ACE_OS::gettimeofday ().msec ());
    }

    this->mycpu_.profile_run ("preA");
    if (this->logEventA_)
    {
      this->logger_.log (LM_INFO, "%s is postprocessing event %d at %d", this->instName_.c_str (), this->eventCountA_, ACE_OS::gettimeofday ().msec ());
    }
    ...
    if (this->logEventA_)
    {
      this->logger_.log (LM_INFO, "%s is finalizing event %d at %d", this->instName_.c_str (), this->eventCountA_, ACE_OS::gettimeofday ().msec ());
    }
  ...
  void CPUBound::push_InPortE_i (antispam::NullEvent * ev)
  {
    ...
    if (this->logEventE_)
    {
      this->logger_.log (LM_INFO, "%s is preprocessing event %d at %d", this->instName_.c_str (), this->eventCountE_, ACE_OS::gettimeofday ().msec ());
    }

    this->mycpu_.profile_run ("preE");
    if (this->logEventE_)
    {
      this->logger_.log (LM_INFO, "%s is postprocessing event %d at %d", this->instName_.c_str (), this->eventCountE_, ACE_OS::gettimeofday ().msec ());
    }
    ...
    if (this->logEventE_)
    {
      this->logger_.log (LM_INFO, "%s is finalizing event %d at %d", this->instName_.c_str (), this->eventCountE_, ACE_OS::gettimeofday ().msec ());
    }
  ...
  void CPUBound::push_InPortC_i (antispam::NullEvent * ev)
  {
    ...
    if (this->logEventC_)
    {
      this->logger_.log (LM_INFO, "%s is preprocessing event %d at %d", this->instName_.c_str (), this->eventCountC_, ACE_OS::gettimeofday ().msec ());
    }

    this->mycpu_.profile_run ("preC");
    if (this->logEventC_)
    {
      this->logger_.log (LM_INFO, "%s is postprocessing event %d at %d", this->instName_.c_str (), this->eventCountC_, ACE_OS::gettimeofday ().msec ());
    }
    ...
    if (this->logEventC_)
    {
      this->logger_.log (LM_INFO, "%s is finalizing event %d at %d", this->instName_.c_str (), this->eventCountC_, ACE_OS::gettimeofday ().msec ());
    }
  ...
  void CPUBound::push_InPortD_i (antispam::NullEvent * ev)
  {
    ...
    if (this->logEventD_)
    {
      this->logger_.log (LM_INFO, "%s is preprocessing event %d at %d", this->instName_.c_str (), this->eventCountD_, ACE_OS::gettimeofday ().msec ());
    }

    this->mycpu_.profile_run ("preD");
    if (this->logEventD_)
    {
      this->logger_.log (LM_INFO, "%s is postprocessing event %d at %d", this->instName_.c_str (), this->eventCountD_, ACE_OS::gettimeofday ().msec ());
    }
    ...
    if (this->logEventD_)
    {
      this->logger_.log (LM_INFO, "%s is finalizing event %d at %d", this->instName_.c_str (), this->eventCountD_, ACE_OS::gettimeofday ().msec ());
    }
  ...
  void CPUBound::ccm_activate (void)
  {
    ...
    this->logger_.connect_using_location (ACE_CString ("control.") + this->testName_ + "antispam.isislab.vanderbilt.edu");
