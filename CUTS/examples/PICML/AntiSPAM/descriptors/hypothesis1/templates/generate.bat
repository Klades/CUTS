...
%CUTS_ROOT%\bin\gmet2m-exec -p %ANTISPAM_DIR%\AntiSPAM.xme --run=MGA.Interpreter.DeploymentPlan --run-output=%ANTISPAM_DIR% --run-focus=DeploymentPlans/TemplateDeployment
