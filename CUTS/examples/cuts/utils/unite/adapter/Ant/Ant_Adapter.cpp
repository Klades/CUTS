...
//
void Ant_Adapter::update_log_format (CUTS_Log_Format * lfmt)
{
...
//
void Ant_Adapter::update_log_format_relations (CUTS_Log_Format * lfmt)
{
...
//
bool Ant_Adapter::update_log_format_variable_values (
...
CUTS_Log_Format_Adapter  * create_Cuts_Log_Format_Adapter (void)
{
  ...
  ACE_NEW_RETURN (adapter, Ant_Adapter, 0);
  return adapter;
}
