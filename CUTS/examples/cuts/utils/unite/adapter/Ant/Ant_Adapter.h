...
#ifndef _ANT_ADAPTER_H_
#define _ANT_ADAPTER_H_
...
#include "Ant_Adapter_export.h"


class ANT_ADAPTER_Export Ant_Adapter : public CUTS_Log_Format_Adapter
{
...
CUTS_LOG_FORMAT_ADAPTER_EXPORT_DECL (ANT_ADAPTER_Export);

#endif /* _ANT_ADAPTER_H_ */
