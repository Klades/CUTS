...
CUTS_CLASSPATH=${CUTS_ROOT}/lib/cuts.java.jar:${CUTS_ROOT}/lib/cuts.java.capi.jar:${CUTS_ROOT%}/lib/cuts.java.capi.deployment.jar:${CUTS_ROOT}/contrib/java/log4j-1.2.15.jar
...
exec ${JAVA_CMD} ${JAVA_OPTS}                                          \
  ...
  cuts.jbi.deployment.JbiExecutionManager "$@"
