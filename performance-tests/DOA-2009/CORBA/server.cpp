...
public:
  ...
  int run_main (int argc, char * argv [])
  {
    try
    {
      ...
      AnyTest_i anytest;
      PortableServer::ObjectId_var oid = this->root_poa_->activate_object (&anytest);
      ...
      std::cout
        << "number any events received: " << anytest.any_count () << std::endl
        << "number any oneway events received:" << anytest.any_oneway_count () << std::endl
        << std::endl;
