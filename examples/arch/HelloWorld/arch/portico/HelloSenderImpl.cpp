...
namespace HelloSenderImpl
{
  ...
  {
    ::Message_var __event_100000010__ (this->ctx_->push_greeting_event ());
    __event_100000010__->time (this->count_ ++);
    __event_100000010__->content (this->message_.c_str ());

    this->ctx_->push_greeting (__event_100000010__);
    this->ctx_->tick ();
  }
  ...
  {
    ::CORBA::String_var s = ::CORBA::string_dup (this->message_.c_str ());
    return s._retn ();
  }
}
