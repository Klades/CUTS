...
#ifndef _OPENSPLICE_HELLOWORLD_COMPONENTSC_H_
#define _OPENSPLICE_HELLOWORLD_COMPONENTSC_H_
...
namespace iCCM 
{
  ...
  class DDS_Traits_T < ::MessageEvent >
  {
    ...
    typedef ::MessageDataReader_ptr reader_ptr_type;
    typedef ::MessageDataReader_var reader_var_type;

    // traits for the writer(s)
    typedef ::MessageDataWriter writer_type;
    typedef ::MessageDataWriter_ptr writer_ptr_type;
    typedef ::MessageDataWriter_var writer_var_type;

    // traits for the type support system
    typedef ::MessageTypeSupport dds_typesupport_type;
    typedef ::MessageTypeSupport_var dds_typesupport_var_type;
    typedef ::MessageTypeSupport_ptr dds_typesupport_ptr_type;
...
#endif  // !defined _OPENSPLICE_HELLOWORLD_COMPONENTSC_H_
