  ...
  public HelloSender_Context_Base
{
  ...
  iCCM::CHAOS_Publisher_Table & get_greeting_ospl_publisher_table (void);

  iCCM::CHAOS_Publisher_Table & get_greeting_ndds_publisher_table (void);

  iCCM::CHAOS_Publisher_Table & get_greeting_tcpip_publisher_table (void);

  private:
  iCCM::CHAOS_Publisher_Table_T < MessageEvent > greeting_ospl_;

  iCCM::CHAOS_Publisher_Table_T < MessageEvent > greeting_ndds_;

  iCCM::CHAOS_Publisher_Table_T < MessageEvent > greeting_tcpip_;
};
  ...
  : public HelloSender_Servant_Base
{
  ...
  virtual ::Components::Cookie * subscribe_greeting_ospl (::MessageEventConsumer_ptr);
  virtual ::MessageEventConsumer_ptr unsubscribe_greeting_ospl (::Components::Cookie *);

  virtual ::Components::Cookie * subscribe_greeting_ndds (::MessageEventConsumer_ptr);
  virtual ::MessageEventConsumer_ptr unsubscribe_greeting_ndds (::Components::Cookie *);

  virtual ::Components::Cookie * subscribe_greeting_tcpip (::MessageEventConsumer_ptr);
  virtual ::MessageEventConsumer_ptr unsubscribe_greeting_tcpip (::Components::Cookie *);
