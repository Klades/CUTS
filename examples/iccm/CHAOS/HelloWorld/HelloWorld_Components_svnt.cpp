...
namespace CHAOS
{
  ...
  iCCM::CHAOS_Publisher & HelloSender_Context::get_greeting_ospl_publisher (void)
  {
    return this->greeting_ospl_;
  }

  iCCM::CHAOS_Publisher & HelloSender_Context::get_greeting_ndds_publisher (void)
  {
    return this->greeting_ndds_;
  }

  iCCM::CHAOS_Publisher & HelloSender_Context::get_greeting_tcpip_publisher (void)
  {
  ...
  {
    this->emits_.bind ("greeting_ospl", &this->ctx_->get_greeting_ospl_publisher ());
    this->emits_.bind ("greeting_ndds", &this->ctx_->get_greeting_ndds_publisher ());
    this->emits_.bind ("greeting_tcpip", &this->ctx_->get_greeting_tcpip_publisher ());
  }
  ...
  void HelloSender_Servant::connect_greeting_ospl (::MessageEventConsumer_ptr)
  {
    throw ::CORBA::NO_IMPLEMENT ();
  }

  ::MessageEventConsumer_ptr HelloSender_Servant::disconnect_greeting_ospl (void)
  {
    throw ::CORBA::NO_IMPLEMENT ();
  }

  void HelloSender_Servant::connect_greeting_ndds (::MessageEventConsumer_ptr)
  {
    throw ::CORBA::NO_IMPLEMENT ();
  }

  ::MessageEventConsumer_ptr HelloSender_Servant::disconnect_greeting_ndds (void)
  {
    throw ::CORBA::NO_IMPLEMENT ();
  }

  void HelloSender_Servant::connect_greeting_tcpip (::MessageEventConsumer_ptr)
  {
    throw ::CORBA::NO_IMPLEMENT ();
  }

  ::MessageEventConsumer_ptr HelloSender_Servant::disconnect_greeting_tcpip (void)
  {
    throw ::CORBA::NO_IMPLEMENT ();
  }
