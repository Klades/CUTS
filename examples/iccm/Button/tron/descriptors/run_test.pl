...
$status = 0;
$dat_file = "ButtonDeployment.cdd";
$cdp_file = "ButtonDeployment.cdp";
...
sub run_node_daemons {
  for ($i = 0; $i < $daemons; ++$i)
  {
      ...
      $d_param = "-ORBEndpoint $iiop -s $node_app -n $nodename=$iorfile -t 30 --locality-config $CUTS_ROOT/bin/handlers/tron.locality.config";
