...
void ExampleCPPFederate::runFederate (const std::string & federateName )
{
    ...
    rtiamb->joinFederationExecution( federateName.c_str (), "ExampleFederation", fedamb );
...
void ExampleCPPFederate::updateAttributeValues( RTI::ObjectHandle objectHandle )
{
    ...
    sprintf( aaValue, "aa:%f", fedamb->federateTime );
    sprintf( abValue, "ab:%f", fedamb->federateTime );
    sprintf( acValue, "ac:%f", fedamb->federateTime );
...
void ExampleCPPFederate::sendInteraction()
{
    ...
    sprintf( xaValue, "xa:%f", fedamb->federateTime );
    sprintf( xbValue, "xb:%f", fedamb->federateTime );
