...
#ifndef _CUTS_BE_QPIDPB_PREPROCESSOR_HANDLERS_H_
#define _CUTS_BE_QPIDPB_PREPROCESSOR_HANDLERS_H_
 ...
 */
template < >
class CUTS_BE_Preprocessor_WorkerLibrary_T <CUTS_BE_QpidPB::Context>
{
public:
 ...
 */
template < >
class CUTS_BE_Preprocessor_WorkerFile_T <CUTS_BE_QpidPB::Context>
{
public:
...
#endif  // !defined _CUTS_BE_QpidPB_PREPROCESSOR_HANDLERS_H_
