...
CUTS_INLINE
CUTS_BE_Workspace_Begin_T <CUTS_BE_CCM::Cpp::Context>::
...
CUTS_INLINE
CUTS_BE_Workspace_Project_Include_T <CUTS_BE_CCM::Cpp::Context, CUTS_BE_Impl_Node>::
CUTS_BE_Workspace_Project_Include_T (CUTS_BE_CCM::Cpp::Context & context)
: visitor_type (context)
{
...
CUTS_INLINE
CUTS_BE_Workspace_End_T <CUTS_BE_CCM::Cpp::Context>::
...
CUTS_INLINE
CUTS_BE_Workspace_File_Close_T <CUTS_BE_CCM::Cpp::Context>::
