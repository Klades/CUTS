...
#ifndef _CUTS_BE_TCPIP_PREPROCESSOR_HANDLERS_H_
#define _CUTS_BE_TCPIP_PREPROCESSOR_HANDLERS_H_
 ...
 */
template < >
class CUTS_BE_Preprocessor_WorkerLibrary_T <CUTS_BE_TCPIP_Ctx>
{
public:
 ...
 */
template < >
class CUTS_BE_Preprocessor_WorkerFile_T <CUTS_BE_TCPIP_Ctx>
{
public:
