...
//
void CUTS_BE_Workspace_Begin_T <CUTS_BE_CCM::Cpp::Context>::
generate (const std::string & name)
{
...
//
void CUTS_BE_Workspace_End_T <CUTS_BE_CCM::Cpp::Context>::
generate (const std::string & name)
{
  this->ctx_.workspace_
    << "}" << std::endl
...
//
void CUTS_BE_Workspace_File_Close_T <CUTS_BE_CCM::Cpp::Context>::generate (void)
{
