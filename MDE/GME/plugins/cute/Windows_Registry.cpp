...
// open
//
int CUTS_Windows_Registry_Key::open (HKEY key, const char * subkey)
{
...
// close
//
void CUTS_Windows_Registry_Key::close (void)
{
  if (0 != this->key_)
    this->close_i ();
}
...
// close
//
void CUTS_Windows_Registry_Key::close_i (void)
{
...
// get_value
//
int CUTS_Windows_Registry_Key::get_value (const char * value,
                                          char * buffer,
...
// advance
//
void CUTS_Windows_Registry_Key_Iterator::advance (void)
{
