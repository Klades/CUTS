...
public:
  ...
  ACE_CString dds2ccm_event_suffix_;
  ...
  const ACE_CString & get_context_template_header_filename (void) const;
  const ACE_CString & get_servant_template_header_filename (void) const;

  const ACE_CString & get_servant_template_typename (void) const;
  const ACE_CString & get_context_typename (void) const;

  const ACE_CString & get_consumer_template_typename (void) const;
  const ACE_CString & get_publisher_typename (void) const;
  const ACE_CString & get_publisher_template_typename (void) const;
  const ACE_CString & get_publisher_table_typename (void) const;
  const ACE_CString & get_publisher_table_template_typename (void) const;

  bool is_dds_eventtype (AST_EventType * node) const;
  bool get_dds_eventtype (AST_EventType * node, ACE_CString & type) const;
