...
#include "CHAOS_Publisher_Table_T.inl"
#endif
...
subscribe (::Components::EventConsumerBase_ptr consumer_base)
{
  ...
  ::Components::CHAOS::EventConsumer_var consumer =
    ::Components::CHAOS::EventConsumer::_narrow (consumer_base);
...
CHAOS_Publisher_Table_T <EVENT>::unsubscribe (::Components::Cookie * c)
{
  //===========================================================================
  // INSERT CODE HERE
  //
