...
int Upcall_Event::visit_eventtype (AST_EventType * node)
{
  ...
  this->hfile_
    ...
    << "{"
    << "public:" << std::endl
    << this->upcall_event_ << " (qpidpb::" << protobuf_event << " & protobuf_event);"
    << "virtual ~" << this->upcall_event_ << " (void);"
    << std::endl;

  this->sfile_
    << this->upcall_event_ << "::" << this->upcall_event_ << " (qpidpb::" << protobuf_event << " & protobuf_event)" << std::endl
    << ": protobuf_event_ (protobuf_event)"
    << "{"
    << "}"
