...
//=============================================================================
/**
 *  @file         Portico_Container_Strategy.h
 *
 *  $Id$
 *
...
#ifndef _ICCM_PORTICO_CONTAINER_STRATEGY_H_
#define _ICCM_PORTICO_CONTAINER_STRATEGY_H_

#include "cuts/iccm/deployment/Container_Strategy_T.h"

#include "Portico_Deployment_Handlers_export.h"
...
/**
 * @class Portico_Container_Strategy
 *
 * Implementation of the iCCM container startegy for Portico.
 */
class ICCM_PORTICO_DEPLOYMENT_HANDLERS_Export Portico_Container_Strategy :
  public Container_Strategy_T <Portico_Container>
{
public:
  /// Type defintion of Portico_Container_Strategy base type.
  typedef Container_Strategy_T <Portico_Container> base_type;
   ...
   */
  Portico_Container_Strategy (Portico_Container & container);

  /// Destructor.
  virtual ~Portico_Container_Strategy (void);
...
#endif  // !defined _ICCM_PORTICO_CONTAINER_STRATEGY_H_
