...
int Event_Traits::visit_eventtype (AST_EventType * node)
{
  ...
  this->hfile_
    ...
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "DataReader reader_type;"
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "DataReader * reader_ptr_type;"
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "DataReader * reader_var_type;"
    << std::endl
    << "// traits for the writer(s)" << std::endl
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "DataWriter writer_type;"
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "DataWriter * writer_ptr_type;"
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "DataWriter * writer_var_type;"
    << std::endl
    << "// traits for the type support system" << std::endl
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "TypeSupport dds_typesupport_type;"
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "TypeSupport * dds_typesupport_var_type;"
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "TypeSupport * dds_typesupport_ptr_type;"
    << std::endl
    << "// event mapping types" << std::endl
    << "typedef ::CoreDX::" << this->scope_ << dds_event << " dds_event_type;"
    << "typedef ::CoreDX::" << this->scope_ << dds_event << "PtrSeq dds_event_sequence_type;"
