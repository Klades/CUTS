...
{
  static const ACE_CString value ("TAO_");
  return value;
}
...
{
  static const ACE_CString value ("cuts/iccm/arch/tao/servant/TAO_Servant_T.h");
  return value;
}
...
{
  static const ACE_CString value ("iCCM::TAO_Servant_T");
  return value;
}
...
{
  static const ACE_CString value ("iCCM::TAO_Publisher_T");
  return value;
}
...
{
  static const ACE_CString value ("iCCM::TAO_Publisher_Table_T");
  return value;
}
...
{
  static const ACE_CString value ("iCCM::TAO_Publisher");
  return value;
}
...
{
  static const ACE_CString value ("iCCM::TAO_Publisher_Table");
  return value;
}
