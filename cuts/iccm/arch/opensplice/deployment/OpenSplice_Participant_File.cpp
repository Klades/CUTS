...
//
// CUTS_OpenSplice_Participant_File
//
CUTS_OpenSplice_Participant_File::CUTS_OpenSplice_Participant_File (void)
: reader_type (&iccm::dds::reader::participant),
  resolver_ (br_)
{
  this->configure ();
}
...
// configure
//
void CUTS_OpenSplice_Participant_File::configure (void)
{
