...
#ifndef _ICCM_TRON_CONTAINER_STRATEGY_H_
#define _ICCM_TRON_CONTAINER_STRATEGY_H_
...
/**
 * @class Tron_Container_Strategy
 *
 * Implementation of the iCCM container startegy for Tron.
 */
class ICCM_TRON_DEPLOYMENT_HANDLERS_Export Tron_Container_Strategy :
  public Container_Strategy_T <Tron_Container>
{
public:
  /// Type defintion of Tron_Container_Strategy base type.
  typedef Container_Strategy_T <Tron_Container> base_type;
   ...
   */
  Tron_Container_Strategy (Tron_Container & container);

  /// Destructor.
  virtual ~Tron_Container_Strategy (void);
...
#endif  // !defined _ICCM_TRON_CONTAINER_STRATEGY_H_
