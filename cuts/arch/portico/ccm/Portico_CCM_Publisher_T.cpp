// Id: Portico_Publisher_T.cpp 3086 2011-01-22 05:53:51Z hillj
...
EVENT * Portico_CCM_Publisher_T <EVENT>::allocate_event (void)
{
...
//
template <typename EVENT>
void Portico_CCM_Publisher_T <EVENT>::send_event (EVENT * ev)
{
...
//
template <typename EVENT>
void Portico_CCM_Publisher_T <EVENT>::init (RTI::RTIambassador * rtiamb)
{
...
connect (::Components::EventConsumerBase_ptr consumer)
{
  ...
  Portico_CCM_Publisher::connect (consumer);
}
...
Portico_CCM_Publisher_T <EVENT>::disconnect (void)
{
  // Pass control to the base class.
  ::Components::EventConsumerBase_ptr consumer =
    Portico_CCM_Publisher::disconnect ();
