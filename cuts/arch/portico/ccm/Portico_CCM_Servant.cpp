...
// advance_time
//
void Portico_CCM_Servant::advance_time (const RTIfedTime & amt)
{
  PORTICO_CCM_TRACE ("Portico_CCM_Servant::advance_time (const RTIfedTime &)");
...
// remove
//
void Portico_CCM_Servant::remove (void)
{
  try
  {
...
{
  PORTICO_CCM_TRACE ("Portico_CCM_Servant::timeAdvanceGrant (const RTI::FedTime &)");
