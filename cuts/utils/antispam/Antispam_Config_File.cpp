...
//
// CUTS_Antispam_Config_File
//
CUTS_Antispam_Config_File::CUTS_Antispam_Config_File (void)
: reader_type (&CUTS::reader::antispam),
  resolver_ (br_)
{
  this->configure ();
}
...
// configure
//
void CUTS_Antispam_Config_File::configure (void)
{
